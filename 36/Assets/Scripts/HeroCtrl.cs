...
public class HeroCtrl : MonoBehaviour
{
    ...
    void UseBombSkill()
    {
        ...
        {
            a_Target.x =  Mathf.Cos(Angle * Mathf.Deg2Rad);

            a_Target.y = 0.0f;
            a_Target.z = Mathf.Sin(Angle * Mathf.Deg2Rad);
            a_Target.Normalize();
            ...
            a_BL_Sc.BulletSpawn(transform.position, a_Target, 30.0f, 120.0f);
