...
public class GlobalUserData 
{
    ...
    public static int g_MonsterKillCount = 0;
    ...
    public static void LoadGameInfo()
    {
        ...
        g_NickName  = PlayerPrefs.GetString("UserNick", "유저");
    
        g_MonsterKillCount = PlayerPrefs.GetInt("MonsterKillCount", 0);
    ...
    public static void ReflashItemSave()  //<-- 리스트 다시 저장
    {
        ...
        for(int i = 0; i < g_ItemList.Count; i++)
        {
            ...
            PlayerPrefs.SetString("UserNick", g_NickName);
            PlayerPrefs.SetInt("MonsterKillCount", g_MonsterKillCount);
